...
| 59 – 63	| The ultrasonic sensor’s main function. Sends out a pulse and the time for the pulse to hit the wall and back is stored. Distance calculation can be done with this duration that was measured. |
